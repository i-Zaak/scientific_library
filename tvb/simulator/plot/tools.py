...
def plot_connectivity(connectivity, num="weights", order_by=None, 
                      plot_hinton=False, plot_tracts=True):
    """
...
##----------------------------------------------------------------------------##
    ...
    def plot_matrix(mat, fig_name='plot_this_matrix', connectivity=None):
        ...
        if connectivity is not None:
            ...
            pyplot.yticks(numpy.arange(connectivity.number_of_regions), list(labels[order]),
                          fontsize=9)
